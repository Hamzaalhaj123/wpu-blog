...
const CarouselPrevious = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = "muted", size = "none", icon = true, ...props }, ref) => {
    ...
    return (
      <Button
        ...
        className={cn(
          ...
          orientation === "horizontal" ? "-start-12 top-1/2 -translate-y-1/2" : "-top-12 start-1/2 rotate-90 -translate-s-1/2",
          className,
        )}
  ...
  ({ className, variant = "muted", size = "none", icon = true, ...props }, ref) => {
    ...
    return (
      <Button
        ...
        className={cn(
          "absolute size-8 rounded-full",
          orientation === "horizontal" ? "-end-12 top-1/2 -translate-y-1/2" : "-bottom-12 start-1/2 rotate-90 -translate-s-1/2",
          className,
        )}
